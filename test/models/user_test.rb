...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should accept valid addresses" do
    valid_addresses = %w[tony@example.com JOHN@test.net Mary_Smith@new.com test@ex-ample.com tony.smith@example.com tony+smith@example.com]
  ...
  test "email validation should not accept invalid addresses" do
    invalid_addresses = %w[test@example test_add_example.com test@example test@ex+ample.com]
